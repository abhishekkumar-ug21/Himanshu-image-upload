...
const ImageUploader = () => {
    ...
    const handleTweet = (imageUrl) => {
        const tweetText = encodeURIComponent("Check out this processed image!");
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-2">
                        {processedImages.map((img) => (
                            <div key={img.size} className="border p-2 cursor-pointer" onClick={() => handleTweet(img.url)}>
